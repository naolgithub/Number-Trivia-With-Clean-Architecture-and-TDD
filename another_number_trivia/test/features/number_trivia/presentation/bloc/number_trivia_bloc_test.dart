...
import 'package:another_number_trivia/features/number_trivia/presentation/bloc/number_trivia_bloc.dart';
...
void main() {
  ...
  group(
    ...
    () {
      ...
      //     when(mockGetConcreateNumberTrivia.call(const Params(number: tNumber)))
